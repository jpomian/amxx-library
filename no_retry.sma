...
public plugin_init() {
	...
	register_cvar("amx_retrymsg","Nie wolno uzywac reconnecta, %s")
	register_cvar("amx_retrykickmsg","Za szybki reconnect")
	register_cvar("amx_retrychatmsg","%s zostal wykopany: reconnect w czasie %t sekund jest zabroniony")
