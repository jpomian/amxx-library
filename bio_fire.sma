...
new const g_model_napalm_player[] = "models/biohazard/p_podpalacz.mdl"
...
new const grenade_fire_player[][] = { "zombie/zombie_burn3.wav", "zombie/zombie_burn4.wav", "zombie/zombie_burn5.wav", "zombie/zombie_burn6.wav", "zombie/zombie_burn7.wav" }
...
cvar_damage, cvar_on, cvar_ff, cvar_cankill, cvar_spread, cvar_botquota,
...
g_ff, g_duration, g_price, g_carrylimit, g_hitself, g_screamrate, g_damage,
...
public plugin_init()
{
	...
	cvar_price = register_cvar("napalm_price", "0")
...
public plugin_natives() {
	...
	register_native("give_user_napalmnade","buy_napalm", 1)
