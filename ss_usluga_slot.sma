...
#define NAZWA_DL "Rezerwacja slota" 			//Nazwa uslugi wyswietlana w menu
#define NAZWA_KR "slot" 			//nazwa uslugi uzywana w logach, jako okienko MOTD itd.
#define FLAGA "b"				//flaga jaka ma dostac gracz
