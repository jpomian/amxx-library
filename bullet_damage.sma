...
public plugin_init( ) 
{
	...
	register_clcmd( "say /bd", "Say_showbd" )
	register_clcmd( "say bd", "Say_showbd" )
	...
	pCvar_AttackerC = 		register_cvar( "Color_RGB_Attacker", "000128255" )
...
public Say_showbd( id ) 
{
	if( ShowMeThisHud[ id ] )
	{
		...
		client_print( id, print_chat, "Obrazenia na ekranie : OFF" )
		return;
	}
	
	client_print( id, print_chat, "Obrazenia na ekranie : ON" )
