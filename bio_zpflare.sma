...
public plugin_init()
{
	register_plugin("[ZP] Grenade: Flare", "0.1a", "ZP Dev Team")
	
	register_forward(FM_SetModel, "fw_SetModel")
	RegisterHam(Ham_Think, "grenade", "fw_ThinkGrenade")
	
	cvar_grenade_flare_duration = register_cvar("zp_grenade_flare_duration", "90")
	cvar_grenade_flare_radius = register_cvar("zp_grenade_flare_radius", "30")
